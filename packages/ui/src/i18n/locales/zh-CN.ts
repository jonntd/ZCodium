...
const zhCN: Record<string, string> = {
  ...
  "settings.modelhub.fetch.action": "拉取模型",
  "settings.modelhub.fetch.failed": "拉取失败：{error}",
  "settings.modelhub.fetch.empty": "该端点返回 0 个模型",
  "settings.modelhub.fetch.addFailed": "添加失败：{model}，{error}",
  "settings.modelhub.fetch.done": "已添加 {count} 个模型",
  "settings.modelhub.headers.action": "请求头模拟",
  "settings.modelhub.headers.title": "请求头模拟",
  "settings.modelhub.headers.hint": "勾选=生效 · 取消勾选=移除 · 仅影响当前渠道",
  "settings.modelhub.headers.count": "勾选 {checked} / {total}",
  "settings.modelhub.headers.tab.claude": "Claude (claude-cli)",
  "settings.modelhub.headers.tab.codex": "Codex (codex_cli_rs)",
  "settings.modelhub.headers.regenerate": "换一个",
  "settings.modelhub.headers.clearAll": "清除全部模拟",
  "settings.modelhub.headers.apply": "应用",
  "settings.modelhub.headers.failed": "请求头保存失败：{error}",
  "settings.modelhub.pick.deleted": "已删除",
  "settings.modelhub.pick.title": "选择要添加的模型",
  "settings.modelhub.pick.summary": "已选 {selected} / {total} 个可添加",
  "settings.modelhub.pick.search": "搜索模型…",
  "settings.modelhub.pick.selectAll": "全选",
  "settings.modelhub.pick.selectNone": "全不选",
  "settings.modelhub.pick.probeChecked": "探测视觉(勾选项)",
  "settings.modelhub.pick.probeAll": "探测全部",
  "settings.modelhub.pick.existing": "已在列表中",
  "settings.modelhub.pick.vision": "视觉 ✓",
  "settings.modelhub.pick.text": "文本",
  "settings.modelhub.pick.empty": "无匹配",
  ...
  "chat.composer.continue.text": "继续",
  "chat.composer.continue.label": "填入「继续」并发送（Cmd/Ctrl+Shift+J）",
  "chat.composer.continue.tooltip": "填入「继续」并立即发送；已有草稿则空格追加后一并发送",
  "chat.composer.stats.tps": "{tps} tok/s",
  "chat.composer.stats.cacheHit": "缓存命中 {percent}%",
  "chat.composer.context.aria": "上下文已用 {percent}",
  "chat.composer.context.used": "上下文已用",
  "chat.composer.enhance.label": "增强提示词",
  "chat.composer.enhance.tooltip": "增强提示词（单击 / Ctrl+/ 增强 · 下拉选模型/模式）",
  "chat.composer.enhance.options": "增强选项（模式/模型）",
  "chat.composer.enhance.current": "当前增强目标：{target}",
  "chat.composer.enhance.followCurrent": "跟随当前模型（{model}）",
  "chat.composer.enhance.channel.auto": "自动（按渠道评分）",
  "chat.composer.enhance.badge.current": "★ 当前渠道",
  "chat.composer.enhance.badge.noKey": "无凭据",
  "chat.composer.enhance.emptyDraft": "请先输入需要增强的提示词",
  "chat.composer.enhance.restoredAuto": "已清除失效指定（{channel}），恢复自动评分链",
  "chat.composer.enhance.manualHint": "手动配置生效中：{model}（enhance-config.json）",
  "chat.composer.enhance.noChannels": "config.json 里没有启用的渠道",
  "chat.composer.enhance.unchanged": "无需增强，已保留原文",
  "chat.composer.enhance.failed": "增强失败：{error}",
